            ...
            <main class="col-md-9">
                ...
                <div class="container">
                    ...
                    <div class="dashboard-item">
                        ...
                        <p><?php $skillset=$_REQUEST['myskill'];
						echo $skillset;  ?></p>
                    </div>
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
                            <button class="ocean-blue-button gradient-button"><a href="https://github.com/rutukavathiya/web_program">Task 1</a></button>
<button class="sunset-orange-button gradient-button"><a href="https://github.com/rutukavathiya/web_program">Task 2</a></button>
